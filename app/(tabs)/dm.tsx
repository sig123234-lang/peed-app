...
const styles = StyleSheet.create({
  // 데스크탑 — 예전엔 센터 컬럼을 통째로 채워서(1920 화면 기준 1300px+) 대화
  // 영역이 지나치게 넓어지고 말풍선이 좌우로 늘어졌다. 목록 320 + 대화
  // APP_MAX_WIDTH(홈 피드와 같은 폭)로 묶고 가운데 정렬해 하나의 패널로 보이게 한다.
  // 바닥색을 colors.bg 로 남겨 페이지(colors.surface) 위에 얹힌 카드처럼 읽힌다.
  desktop: {
    flex: 1,
    flexDirection: 'row',
